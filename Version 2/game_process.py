...
class GameProcess:
    def __init__(self, game_screen, fps, clock, language, world_layout, player_coordinate):
        ...
        self.world = World(self.game_screen, [154, 128], world_layout, player_coordinate)
        self.player = Player(self.game_screen, self.fps)
        self.game_flag = True
        self.pressed_buttons = {'up': [False, 'y', '-'], 'down': [False, 'y', '+'], 'left': [False, 'x', '-'], 'right': [False, 'x', '+']}
    ...
    def checking_actions(self, event_outer):
        ...
        for button in self.pressed_buttons:
            if self.pressed_buttons[button][0]:
                ...
                self.player.change_position(self.pressed_buttons[button][1], self.player.player_motion_step, self.pressed_buttons[button][2])
    ...
    def game_process(self):
        ...
        while self.game_flag:
            ...
            self.world.draw_world(self.frame_rate_counter)
