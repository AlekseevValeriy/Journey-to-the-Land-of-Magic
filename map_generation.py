...
class MapGeneration:
    ...
    def the_chopper(self):
        ...
        while True:
            ...
            if break_point == 100:
                break
            if ((true_vertical + self.point_sizes[0] + 1) <= self.wieght) and ((true_gorizontal + self.point_sizes[0] + 1) <= self.hight) and (true_vertical - self.point_sizes[0] >= 0) and (true_gorizontal - self.point_sizes[0] >= 0) and prove_collision:
